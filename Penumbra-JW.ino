...
//
//   Define MY_BT_ADDR to the address stored in your PS3 Navigation controller. Or update
    ...
    virtual void notify() override
    {
        ...
        else
        {
            ...
            if (event.button_down.cross)
            {
                ...
                servoDispatch.moveServosTo(TEST_ONE, 50, 500, 1.0);
                myDFPlayer.play(1);
            }
            ...
            if (event.button_down.circle)
            {
                ...
                servoDispatch.moveServosTo(TEST_ONE, 50, 500, 0.0);
            }
